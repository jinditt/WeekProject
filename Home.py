...
- **연간 관광객수** : '주요 관광지점 입장객 통계'의 2018~2023년의 연도별 데이터
- **역사 명소의 '유형'** : 한국문화정보원에서 제공되는 '국내 지역별 유적지' 데이터를 기반으로 분류 (궁궐/종묘, 왕릉/고분, 보물, 국보, 유명사적/유적지, 비/탑/문/각, 서원/향교/서당, 고택/생가/민속마을, 유명사찰, 성/성터, 천연기념물 등 총 11가지)
- **역사 명소 소개** : 한국관광공사의 Tour API에서 제공되는 관광지 기본 정보 활용
- **리뷰 데이터** : 역사적 명소별 구글지도의 리뷰 중 1000개 리뷰데이터를 추출하여 활용
''')
